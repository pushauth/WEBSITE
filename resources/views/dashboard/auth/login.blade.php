                ...
                <div class="form-box-inner">
                    ...
                    <div class="row">
                        <div class="form-container col-md-5 col-sm-12 col-xs-12">
                                ...
                                {!! Form::open(array('route' => 'loginPost', 'class'=>'login-form', 'autocomplete'=>'off')) !!}
                            ...
                            <div class="form-group password @if ($errors->has('password')) has-error @endif">
                                ...
                                {!! Form::password('password', array('class'=>'form-control login-email', 'type'=>'password', 'id'=>'login-password',
                                 'autocorrect'=>'off', 'autocapitalize'=>'off', 'autocomplete'=>'off', 'placeholder'=>'Password')) !!}
                                @if ($errors->has('password')) <p class="help-block">{{ $errors->first('password') }}</p> @endif
                                <p class="forgot-password"><a href="{{route('forgotPassword')}}">Forgot password?</a></p>
                            ...
                            {!! Form::button('Login', array('type' => 'submit', 'class'=>'btn btn-block btn-primary')) !!}
                                ...
                                <p class="alt-path">Need an account? <a class="signup-link" href="{{route('register')}}">Sign up now</a></p>
                            {!! Form::close() !!}
                        </div>

                        <div class="social-btns col-md-5 col-sm-12 col-xs-12 col-md-offset-1 col-sm-offset-0 col-sm-offset-0">
                            <div class="divider"><span>about</span></div>
                            <p class="text-muted">It is secure service. We don't store any passwords. Only transfer short-time hash with digital sign.</p>
                        </div>
