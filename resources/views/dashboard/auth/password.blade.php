                    ...
                    <div class="row">
                        <div class="form-container col-md-6 col-md-offset-3">
                            @if (session('status'))
                                ...
                                <p class="alert alert-info alert-theme-solid alert-dismissible" role="alert">
                            ...
                            @else
                            {!! Form::open(array('route' => 'forgotPost', 'class'=>'login-form', 'autocomplete'=>'off')) !!}
                            ...
                            {!! Form::button('Reset', array('type' => 'submit', 'class'=>'btn btn-block btn-primary')) !!}
