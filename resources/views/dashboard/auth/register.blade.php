                ...
                <div class="form-box-inner">
                    ...
                    <div class="row">
                        <div class="form-container col-md-5 col-sm-12 col-xs-12">
                            ...
                            {!! Form::open(array('route' => 'registerPost', 'class'=>'login-form', 'autocomplete'=>'off')) !!}
                            ...
                            {!! Form::button('Sign Up', array('type' => 'submit', 'class'=>'btn btn-block btn-primary')) !!}

                            <p class="note">By signing up, you agree to our terms of services and privacy policy.</p>
                            <p class="alt-path">Already have an account? <a class="login-link" href="{{route('login')}}">Login</a></p>
