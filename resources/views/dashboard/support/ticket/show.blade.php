                                   ...
                                   <div class="">
                                       <div class="topic-holder">
                                           <div class="topic-author">
                                               <img class="img-responsive img-circle" src="{{$user->img}}" alt="">
                                           </div>
                                           <div class="topic-content-wrapper">
                                               <cite class="name">You started the topic with subject: <strong>{{$ticket->subject}}</strong></cite>
                                        ...
                                        <span class="size-11 margin-bottom-8 bold block"><strong>{{$ticket->files()->Img('false')->count()}}
                                            attachments</strong></span>
...
@endif
                                       ...
                                       <div class="row">
                                          <div class="col-md-6 col-md-offset-3">
                                              <a href="{{route('support.ticket.close', $ticket->url_hash)}}" type="button" class="btn btn-block btn-pink btn-lg">Close ticket</a>
                                              <br>
                                          </div>
                                       </div>
                                       ...
                                       <div class="reply-holder">
                                           ...
                                           <div class="reply-content">
                                               ...
                                               <div class="form-holder">
                                                   ...
                                                   {!! Form::open(array('route' => ['support.ticket.store.comment',$ticket->url_hash], 'autocomplete'=>'off', 'files'=> true, 'method'=>'PATCH', 'class'=>'margin-bottom-lg')) !!}
