        ...
        <div class="row">
            <div class="form-box col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-sm-offset-0 xs-offset-0">
                ...
                <div class="jumbotron text-center error-404">
                    <h1>Success!</h1>
                    <p class="margin-bottom-lg">Thank you! You success confirmed yor device and now you can SignIn in your device.</p>
                    <div class="action"><a class="btn btn-primary btn-lg" href="https://pushauth.io/" role="button">Back to Home</a></div>
                </div>
            </div>
